      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('address-card', 'manage_invoice.php', 'Manage Invoices');
            createSection2('handshake', 'add_customer.php', 'Add New Customer');
            createSection2('handshake', 'manage_customer.php', 'Manage Customers');
            createSection2('shopping-bag', 'manage_medicine.php', 'Manage Medicines');
            createSection2('shopping-bag', 'manage_medicine_stock.php', 'Manage Stocks');
            createSection2('group', 'add_supplier.php', 'Add New Supplier');
            createSection2('group', 'manage_supplier.php', 'Manage Supplier');
            createSection2('bar-chart', 'add_purchase.php', 'Add New Purchase');
            createSection2('bar-chart', 'manage_purchase.php', 'Manage Purchase');
